...
INSERT INTO `User` (`email`, `firstname`, `lastname`, `password`, `role`) VALUES ('test@test.ch', 'Test', 'Test', '$2a$10$Isct.0ROCG.X01dkHKrueePP6FeGUnOSZc2uv0ztQAQOJWzC.PJ3q', 'user');
